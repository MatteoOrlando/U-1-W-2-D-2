...
if (numero1 === 4 || numero2 === 4 || numero1 + numero2 === 8 || numero1 - numero2 === 8) {
...
// Calcolo del totale
let totale = shoppingCart + costoSpedizione;
console.log("L'ammontare totale da addebitare all'utente è: " + totale);
...
// Calcolo del totale
let totale = shoppingCart - sconto;
console.log("L'ammontare totale da addebitare all'utente è: " + totale);
